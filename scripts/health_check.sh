...
python3 -m compileall -q config.py database.py backup_utils.py migrate.py secpath_meta.py dashboard proxy_monitor proxy_importer proxy_server public_monitor scripts tests
