...
def parse_args():
    ...
    parser.add_argument("--require_web_https", action="store_true", help="Only use proxies validated for HTTPS/IP web traffic")
    parser.add_argument("--require_remote_dns", action="store_true", help="Only use proxies validated for proxy-side DNS")
    parser.add_argument("--require_telegram", action="store_true", help="Only use proxies validated against Telegram reachability")
